...
const HeroSection = () => {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      {/* Animated Squares Background with Exact 3px Blur */}
      <div
      ...
      <main className="relative z-10 h-[calc(100vh-80px)] flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <button onClick={() => window.location.href = '/contact'} className="px-6 py-3 bg-[#CBFE47] text-neutral-900 rounded-full hover:bg-green-400 transition-all flex items-center gap-2">
            👋 Let's talk
          </button>
          <button onClick={() => window.location.href = '/projects'} className="px-6 py-3 bg-neutral-800 text-white rounded-full hover:text-[#CBFE47] hover:bg-neutral-700 transition-all flex items-center gap-2">
            Explore Projects <i class="fa-solid fa-location-arrow"></i>
          </button>
        </div>
